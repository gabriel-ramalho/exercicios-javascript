...
da tabelinha, que já é um sucesso na sua loja de 1,99. Você foi contratado para desenvolver
 o programa que monta a tabela de preços de pães, de 1 até 50 pães, a partir do preço do 
...
...
50 - R$ 9.00 */
let precoPao = parseFloat(prompt("Qual valor do pão?"))
for(let i = 1; i <= 50; i++){
  console.log(i + " - R$ "+ precoPao*i)
}